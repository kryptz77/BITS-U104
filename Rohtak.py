...
fig.suptitle('Rohtak Temperature Analysis (1984–2023)\nNASA POWER MERRA-2 Data',
...
plt.tight_layout()
plt.savefig('rohtak_temperature_analysis.png', dpi=150, bbox_inches='tight')
print("\nPlot saved as rohtak_temperature_analysis.png")
